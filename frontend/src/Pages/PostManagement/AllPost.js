...
import './AllPost.css'; // CSS file for additional styles
    ...
    <div className="alt-posts-container">
      ...
      <div className="alt-content-wrapper">
        <div className="alt-header">
          <h1 className="alt-title">Explore Posts</h1>
          ...
          <div className="alt-filter-toggle">
            <button 
              className={`alt-filter-btn ${showMyPosts ? 'active' : ''}`}
              onClick={handleMyPostsToggle}
            >
              {showMyPosts ? 'Viewing My Posts' : 'View My Posts'}
            </button>
          </div>
        </div>
                ...
                <div className="alt-post-header">
                  ...
                  <div className="alt-post-options">
                    {post.userID !== loggedInUserID && (
                      <button
                        className={`alt-follow-btn ${followedUsers.includes(post.userID) ? 'following' : ''}`}
                ...
                <div className="alt-comment-section">
                  <div className="alt-comment-form">
                    <div className="alt-current-user-avatar">
                      {/* You can replace this with the actual user's initial */}
